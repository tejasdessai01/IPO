...
const insertIpo = db.prepare(`
  INSERT INTO ipos (
    id, company_name, logo_url, status, ipo_type,
    open_date, close_date, listing_date,
    price_band_low, price_band_high, face_value, lot_size, min_investment,
    issue_size_cr, fresh_issue_cr, ofs_cr,
    subscription_retail, subscription_nii, subscription_qib, subscription_total,
    gmp, gmp_percent, gmp_updated_at,
    listing_price, listing_gain_percent, current_price,
    industry, description, about, business_model,
    strengths, risks, financials_json,
    promoters, lead_managers, registrar,
    drhp_url, rhp_url,
    ai_summary, ai_verdict, ai_score,
    allotment_date, allotment_status_url, source_url
  ) VALUES (
    ?, ?, ?, ?, ?,
    ?, ?, ?,
    ?, ?, ?, ?, ?,
...
const insertTimeline = db.prepare(`
  INSERT INTO timeline_events (ipo_id, event_type, event_date, label)
  VALUES (?, ?, ?, ?)
`);
...
const ipos = [
  {
    ...
    fresh_issue_cr: 0,
    ofs_cr: 8750,
    subscription_retail: 1.93,
    subscription_nii: 0.68,
    subscription_qib: 3.41,
    subscription_total: 2.66,
    gmp: 0,
    gmp_percent: 0,
    gmp_updated_at: '2025-02-19T10:00:00Z',
    listing_price: 731,
    listing_gain_percent: 3.25,
    current_price: 745,
    ...
    ai_score: 7,
    allotment_date: '2025-02-17',
    allotment_status_url: 'https://kosmic.kfintech.com/ipostatus',
    source_url: null,
  },
  {
    ...
    fresh_issue_cr: 300,
    ofs_cr: 2727,
    subscription_retail: 5.12,
    subscription_nii: 3.89,
    subscription_qib: 22.45,
    subscription_total: 13.28,
    gmp: 0,
    gmp_percent: 0,
    gmp_updated_at: '2025-02-05T10:00:00Z',
    listing_price: 440,
    listing_gain_percent: 9.45,
    current_price: 458,
    industry: 'Healthcare',
    ...
    ai_verdict: 'subscribe',
    ai_score: 8,
    allotment_date: '2025-02-03',
    allotment_status_url: 'https://linkintime.co.in/initial_offer',
    source_url: null,
  },
  {
    ...
    face_value: 10,
    lot_size: 35,
    min_investment: 14875,
    issue_size_cr: 858,
    fresh_issue_cr: 500,
    ofs_cr: 358,
    subscription_retail: 7.56,
    subscription_nii: 12.34,
    subscription_qib: 45.67,
    subscription_total: 28.12,
    gmp: 0,
    gmp_percent: 0,
    gmp_updated_at: '2025-02-21T10:00:00Z',
    listing_price: 498,
    listing_gain_percent: 17.18,
    current_price: 512,
  ...
  },
  {
    ...
    fresh_issue_cr: 2520,
    ofs_cr: 0,
    subscription_retail: 2.34,
    subscription_nii: 1.89,
    subscription_qib: 5.67,
    subscription_total: 3.78,
    gmp: 0,
    gmp_percent: 0,
    gmp_updated_at: '2025-01-14T10:00:00Z',
    listing_price: 101,
  ...
  },
  {
    ...
    fresh_issue_cr: 3560,
    ofs_cr: 3000,
    subscription_retail: 7.41,
    subscription_nii: 32.68,
    subscription_qib: 209.43,
    subscription_total: 63.61,
    gmp: 0,
    gmp_percent: 0,
    gmp_updated_at: '2024-09-16T10:00:00Z',
    listing_price: 150,
    listing_gain_percent: 114.29,
    current_price: 132,
  ...
  },
  {
    ...
    face_value: 2,
    lot_size: 33,
    min_investment: 14124,
    issue_size_cr: 698,
    fresh_issue_cr: 138,
    ofs_cr: 560,
    subscription_retail: 3.45,
    subscription_nii: 8.12,
    subscription_qib: 56.78,
    subscription_total: 29.34,
    gmp: 45,
    gmp_percent: 10.51,
    gmp_updated_at: '2025-02-26T14:00:00Z',
    listing_price: null,
  ...
  },
  {
    ...
    fresh_issue_cr: 501,
    ofs_cr: 0,
    subscription_retail: 12.45,
    subscription_nii: 28.67,
    subscription_qib: 89.12,
    subscription_total: 54.23,
    gmp: 32,
    gmp_percent: 35.56,
    gmp_updated_at: '2025-02-26T14:00:00Z',
    listing_price: null,
    ...
    ai_verdict: 'subscribe',
    ai_score: 6,
    allotment_date: '2025-01-21',
    allotment_status_url: null,
    source_url: null,
  },
  {
    id: 'ather-energy-ipo',
    ...
    gmp: 22,
    gmp_percent: 6.85,
    gmp_updated_at: '2025-02-27T09:00:00Z',
    listing_price: null,
    listing_gain_percent: null,
    current_price: null,
  ...
  },
  {
    ...
    fresh_issue_cr: 78,
    ofs_cr: 0,
    subscription_retail: 4.23,
    subscription_nii: 6.78,
    subscription_qib: 0,
    subscription_total: 4.89,
    gmp: 55,
    gmp_percent: 23.81,
    gmp_updated_at: '2025-02-28T08:00:00Z',
    listing_price: null,
    listing_gain_percent: null,
    current_price: null,
  ...
  },
  {
    ...
    fresh_issue_cr: 42,
    ofs_cr: 0,
    subscription_retail: 15.34,
    subscription_nii: 22.56,
    subscription_qib: 0,
    subscription_total: 17.45,
    gmp: 18,
    gmp_percent: 45.0,
    gmp_updated_at: '2025-02-28T08:00:00Z',
    listing_price: null,
    ...
    business_model: 'Revenue comes from manufacturing and selling transformers to state electricity boards, private utilities, and industrial customers. The company receives orders through competitive bidding and direct sales. Export revenue contributes about 20% of total sales, providing currency diversification.',
  ...
  },
  {
    ...
    face_value: 10,
    lot_size: 2000,
    min_investment: 114000,
    issue_size_cr: 29,
    fresh_issue_cr: 29,
    ofs_cr: 0,
    subscription_retail: 2.12,
    subscription_nii: 3.45,
    subscription_qib: 0,
    subscription_total: 2.56,
    gmp: 12,
    gmp_percent: 21.05,
    gmp_updated_at: '2025-02-28T08:00:00Z',
    listing_price: null,
...
const insertMany = db.transaction((data: typeof ipos) => {
  for (const ipo of data) {
    insertIpo.run(
      ipo.id, ipo.company_name, ipo.logo_url, ipo.status, ipo.ipo_type,
      ipo.open_date, ipo.close_date, ipo.listing_date,
      ipo.price_band_low, ipo.price_band_high, ipo.face_value, ipo.lot_size, ipo.min_investment,
      ipo.issue_size_cr, ipo.fresh_issue_cr, ipo.ofs_cr,
      ipo.subscription_retail, ipo.subscription_nii, ipo.subscription_qib, ipo.subscription_total,
      ipo.gmp, ipo.gmp_percent, ipo.gmp_updated_at,
      ipo.listing_price, ipo.listing_gain_percent, ipo.current_price,
      ipo.industry, ipo.description, ipo.about, ipo.business_model,
      ipo.strengths, ipo.risks, ipo.financials_json,
      ipo.promoters, ipo.lead_managers, ipo.registrar,
      ipo.drhp_url, ipo.rhp_url,
      ipo.ai_summary, ipo.ai_verdict, ipo.ai_score,
      ipo.allotment_date, ipo.allotment_status_url, ipo.source_url
    );

    // Add timeline events
    if (ipo.open_date) {
      insertTimeline.run(ipo.id, 'open', ipo.open_date, 'IPO Opens');
    }
    if (ipo.close_date) {
      insertTimeline.run(ipo.id, 'close', ipo.close_date, 'IPO Closes');
    }
    if (ipo.allotment_date) {
      insertTimeline.run(ipo.id, 'allotment', ipo.allotment_date, 'Allotment');
    }
    if (ipo.listing_date) {
      insertTimeline.run(ipo.id, 'listing', ipo.listing_date, 'Listing');
    }

    // Add GMP history for IPOs with GMP data
    if (ipo.gmp !== 0 && ipo.open_date) {
      const baseDate = new Date(ipo.open_date);
      const gmpBase = ipo.gmp;
      for (let i = -14; i <= 0; i++) {
        const date = new Date(baseDate);
        date.setDate(date.getDate() + i);
        const variation = (Math.random() - 0.5) * gmpBase * 0.4;
        const dayGmp = Math.round(gmpBase + variation);
        insertGmpHistory.run(
          ipo.id,
          dayGmp,
          date.toISOString().split('T')[0] + 'T12:00:00Z'
        );
      }
    }
  }
...
console.log(`Seeded ${ipos.length} IPOs successfully!`);
